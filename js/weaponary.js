...
export class Weapon {
    ...
    draw(ctx) {
        ...
        const scale = (this.type === 'crown') ? 1.0 : (this.type === 'lightning' ? 0.6 : (this.type === 'magic_spear' ? 0.78 : (this.type === 'poison_potion' ? 0.624 : (this.type === 'boomerang' ? 0.49 : (this.type === 'magic_dagger' ? 1.056 : 0.8)))));
        ctx.save();
